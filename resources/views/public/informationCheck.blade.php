...
<div class="container" style="margin-top: 90px;">
    <div class="text-center mb-5">
        <h2 class="mb-1">Cek Status Permohonan Informasi Publik</h2>
    </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form id="searchForm">
                        ...
                        <div class="mb-3">
                            <label for="request_code" class="form-label">Kode Permohonan</label>
                            <input type="text" id="request_code" name="request_code" class="form-control" placeholder="Masukkan Kode Keberatan" required>
                        </div>
                        <div class="d-grid">
...
<script>
     document.getElementById('searchButton').addEventListener('click', function() {
        ...
        const requestCode = document.getElementById('request_code').value.trim();
        ...
        fetch(`{{ route('request.status') }}?nik=${nik}&request_code=${requestCode}`, {
            method: 'GET',
