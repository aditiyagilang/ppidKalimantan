                ...
                <div class="col-lg-8">
                    ...
                    <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Laporan Penyelenggaraan</h4>
                        ...
                        @foreach($administration as $administration)
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    ...
                                    src="{{ asset('assets/foto/' . $administration->photo) }}" 
                                    style="object-fit: cover;" 
                                    onerror="this.onerror=null; this.src='https://via.placeholder.com/300';">

                                    <div class="bg-white border border-top-0 p-4">
                                        <!-- Judul dan deskripsi -->
                                        <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="#">{{$administration->year}}</a>

                                        <!-- Tombol Download -->
                                        <a href="{{ asset('assets/file/' . $administration->file) }}" 
                                        download="{{ $administration->file }}" 
