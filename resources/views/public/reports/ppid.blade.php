                ...
                <div class="col-lg-8">
                    ...
                    <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Laporan PPID</h4>
                               
                            </div>
                        </div>
                    
                        @foreach($ppid as $ppid)
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <!-- Ganti src dengan data dari database -->
                                    <img class="img-fluid w-100" 
                                    src="{{ asset('assets/foto/' . $ppid->photo) }}" 
                                    style="object-fit: cover;" 
                                    onerror="this.onerror=null; this.src='https://via.placeholder.com/300';">

                                    <div class="bg-white border border-top-0 p-4">
                                        <!-- Judul dan deskripsi -->
                                        <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="#">{{$ppid->year}}</a>

                                        <!-- Tombol Download -->
                                        <a href="{{ asset('assets/file/' . $ppid->file) }}" 
                                        download="{{ $ppid->file }}" 
